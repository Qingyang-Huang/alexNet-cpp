...
/*
#undef cv_hal_resize
#define cv_hal_resize THEAD_NS::csi_resize_linear

#undef cv_hal_morphInit
#define cv_hal_morphInit dilate_u8_init

#undef cv_hal_morph
#define cv_hal_morph dilate_u8

//#undef cv_hal_morphFree
//#define cv_hal_morphFree dilate_u8_deinit
...
#define cv_hal_split8u split_u8
#undef cv_hal_split16u
#define cv_hal_split16u split_u16
#undef cv_hal_split32s
#define cv_hal_split32s split_s32
#undef cv_hal_split64s
#define cv_hal_split64s split_s64

#undef cv_hal_merge8u
#define cv_hal_merge8u merge_u8
#undef cv_hal_merge16u
#define cv_hal_merge16u merge_u16
#undef cv_hal_merge32s
#define cv_hal_merge32s merge_s32
#undef cv_hal_merge64s
#define cv_hal_merge64s merge_s64
...
#undef cv_hal_sobel
#define cv_hal_sobel sobel_u8

#undef cv_hal_medianBlur
#define cv_hal_medianBlur median_blur_u8

#undef cv_hal_cvtBGRtoBGR
#define cv_hal_cvtBGRtoBGR cvt_bgr_bgr_u8

#undef cv_hal_cvtBGRtoBGR5x5
#define cv_hal_cvtBGRtoBGR5x5 cvt_bgr_bgr5x5_u8

#undef cv_hal_cvtBGR5x5toBGR
#define cv_hal_cvtBGR5x5toBGR cvt_bgr5x5_bgr_u8

#undef cv_hal_cvtBGRtoGray
#define cv_hal_cvtBGRtoGray cvt_bgr_gray_u8

#undef cv_hal_cvtGraytoBGR
#define cv_hal_cvtGraytoBGR cvt_gray_bgr_u8
...
#define cv_hal_cvtBGRtoXYZ cvt_bgr_xyz_u8

#undef cv_hal_cvtXYZtoBGR
#define cv_hal_cvtXYZtoBGR cvt_xyz_bgr_u8

#undef cv_hal_cvtTwoPlaneYUVtoBGR
#define cv_hal_cvtTwoPlaneYUVtoBGR cvt_yuv420sp_bgr_u8

#undef cv_hal_cvtTwoPlaneYUVtoBGREx
#define cv_hal_cvtTwoPlaneYUVtoBGREx cvt_yuv420sp_bgr_ex_u8

#undef cv_hal_cvtThreePlaneYUVtoBGR
#define cv_hal_cvtThreePlaneYUVtoBGR cvt_yuv420p_bgr_u8

#undef cv_hal_cvtBGRtoThreePlaneYUV
#define cv_hal_cvtBGRtoThreePlaneYUV cvt_bgr_yuv420p_u8

#undef cv_hal_cvtBGRtoTwoPlaneYUV
#define cv_hal_cvtBGRtoTwoPlaneYUV cvt_bgr_yuv420sp_u8

#undef cv_hal_cvtOnePlaneYUVtoBGR
#define cv_hal_cvtOnePlaneYUVtoBGR cvt_yuv422_bgr_u8

//#undef cv_hal_cvtRGBAtoMultipliedRGBA
//#define cv_hal_cvtRGBAtoMultipliedRGBA cvt_bgra_mbgra_u8

//#undef cv_hal_cvtMultipliedRGBAtoRGBA
//#define cv_hal_cvtMultipliedRGBAtoRGBA cvt_mbgra_bgra_u8
...
#define cv_hal_filterInit filter_init

#undef cv_hal_filter
#define cv_hal_filter filter

#undef cv_hal_filterFree
#define cv_hal_filterFree filter_free

//#undef cv_hal_integral
//#define cv_hal_integral integral_wrap

#undef cv_hal_warpAffine
#define cv_hal_warpAffine warp_affine

#undef cv_hal_warpPerspective
#define cv_hal_warpPerspective warp_perspective

#undef cv_hal_pyrdown
#define cv_hal_pyrdown pyrdown

#undef cv_hal_optflowpyrLK
#define cv_hal_optflowpyrLK optflowpyrLK
...
#undef cv_hal_norm1
#define cv_hal_norm1 wrap_norm1
#endif
